function ConfigureDNSOverHTTPS {
    ...
    if ($providerValue -ne "https://protected.cira.ca/dns-query") {
        Set-ItemProperty -Path $regPath -Name "DNSOverHTTPS.ProviderURL" -Value "https://protected.cira.ca/dns-query"
