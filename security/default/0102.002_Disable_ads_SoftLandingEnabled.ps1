...
- SoftLandingEnabled: Disables soft landing, which is the process of gradually introducing new features to users.
...
Set-RegistryValue -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" -PropertyName "SoftLandingEnabled" -Value 0
