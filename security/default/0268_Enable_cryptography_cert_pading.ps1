...
$cve_2013_3900_regKey32bit = Get-ItemProperty -Path Registry::$32bitpath  -Name $RegentryName -ErrorAction SilentlyContinue
...
$cve_2013_3900_regKey64bit = Get-ItemProperty -Path Registry::$64bitpath -Name $RegentryName -ErrorAction SilentlyContinue
...
If ($cve_2013_3900_32bitMitigated -and $cve_2013_3900_64bitMitigated) { 
  Write-Output "CVE_2013_3900_mitigation_status : Mitigated" 
} 
Else { 
  Write-Output "CVE_2013_3900_mitigation_status : NOT Mitigated"
  Write-Output "Mitigating CVE_2013_3900..." 

  #Creates required keys paths
  ...
  Write-Output "CVE_2013_3900_mitigation_status : $cve_2013_3900_mitigated "
