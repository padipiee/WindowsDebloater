...
netsh advfirewall firewall add rule name="telemetry_watson.telemetry.microsoft.com_65.55.252.43-65.52.108.29" dir=out action=block remoteip=65.55.252.43,65.52.108.29 enable=yes
netsh advfirewall firewall add rule name="telemetry_redir.metaservices.microsoft.com_194.44.4.200-194.44.4.208" dir=out action=block remoteip=194.44.4.200,194.44.4.208 enable=yes
netsh advfirewall firewall add rule name="telemetry_choice.microsoft.com_157.56.91.77" dir=out action=block remoteip=157.56.91.77 enable=yes
