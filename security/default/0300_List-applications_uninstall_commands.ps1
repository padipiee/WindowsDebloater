...
#List applications and provide if available uninstall command

#https://raw.githubusercontent.com/ReneNyffenegger/about-Windows-Registry/master/HKEY_LOCAL_MACHINE/SOFTWARE/Microsoft/Windows/CurrentVersion/Uninstall/list-applications.ps1
