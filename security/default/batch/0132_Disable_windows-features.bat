@echo off
echo Windows 10 Home and Pro Hardening : Dism Features
...
::Dism.exe /Online /Disable-Feature /NoRestart /featurename:RasRip
...
:: Dism.exe /Online /Disable-Feature /NoRestart /featurename:WMISnmpProvider
